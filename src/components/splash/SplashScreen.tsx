...
export function SplashScreen({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[100dvh] w-full bg-surface px-6 py-12 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-3 bg-vibrant-yellow border-b-[3px] border-deep-charcoal animate-slide-down" />

      {/* Logo */}
      <div className="mb-10 w-[240px] h-[240px] relative flex-shrink-0 z-10 animate-scale-fade" style={{ animationDelay: '100ms' }}>
      ...
      {/* Tagline */}
      <h2
        className="font-anton text-[40px] leading-[1.1] tracking-wide text-deep-charcoal mb-10 text-center uppercase animate-slide-up-fade"
      ...
      <Link
        ...
        className={`group relative w-full max-w-[340px] bg-deep-charcoal text-vibrant-yellow font-anton text-[22px] tracking-wider uppercase py-4 px-6 rounded-full flex items-center justify-between border-[3px] border-deep-charcoal transition-all duration-200 animate-slide-up-fade ${isLoading ? 'opacity-90 pointer-events-none' : 'hover:bg-surface hover:text-deep-charcoal active:scale-[0.98]'}`}
      ...
      {/* Social Media Bar */}
      <footer
        className="w-full max-w-[340px] mt-12 flex flex-col items-center animate-slide-up-fade"
